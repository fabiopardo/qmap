...
import numpy as np
import os
from q_map_renderer import Q_Map_Renderer
import tempfile
...
class Q_Map():
    def __init__(self,
        ...
        self.compute_q_values, self.compute_double_q_values, self.train, self.update_target, _ = q_map.build_train(
...
class Q_Map_DQN_Agent(Agent):
    def __init__(self,
        ...
        self.path = '{}/results/q-map/{}/{}/{}'.format(home, env_name, agent_name, sub_name)
